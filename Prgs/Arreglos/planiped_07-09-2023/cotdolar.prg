...
SQLEXEC(cn1,"select * from pedidos where cotiz_dolar > 0 order by ped_codi;","cur_ped1")
...
SCAN
	xped = cur_ped1.ped_codi
	xdolar = cur_ped1.cotiz_dolar
	...
	SQLEXEC(cn2,"update pedidos set cotiz_dolar = ?xdolar where ped_codi = ?xped;")
